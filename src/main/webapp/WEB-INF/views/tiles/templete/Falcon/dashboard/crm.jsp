            ...
            <div class="col">
              <div class="card bg-100 shadow-none border">
                <div class="row gx-0 flex-between-center">
                  <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2" src="/resources/Falcon/img/assets/img/illustrations/crm-bar-chart.png" alt="" width="90" />
                    <div>
                    ...
                    </div><img class="ms-n4 d-md-none d-lg-block" src="/resources/Falcon/img/assets/img/illustrations/crm-line-chart.png" alt="" width="150" />
                  </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-xxl-12 col-md-7">
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 pt-md-0 pt-xxl-3">
                        <div class="d-flex"><img class="me-2" src="/resources/Falcon/img/assets/img/crm/email.svg " width="16" height="16" alt="..." />
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex"><img class="me-2" src="/resources/Falcon/img/assets/img/crm/social.svg " width="16" height="16" alt="..." />
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3">
                        <div class="d-flex"><img class="me-2" src="/resources/Falcon/img/assets/img/crm/call.svg " width="16" height="16" alt="..." />
                      ...
                      <div class="d-flex flex-between-center border-bottom py-3 border-bottom-0 pb-0">
                        <div class="d-flex"><img class="me-2" src="/resources/Falcon/img/assets/img/crm/other.svg " width="16" height="16" alt="..." />
