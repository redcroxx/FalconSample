                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row g-3 align-items-center">
                      <div class="col-md-6 col-lg-12 text-center"><img class="img-fluid rounded-3" src="./resources/Falcon/img/assets/img/elearning/avatar/trainer.png" alt="" /></div>
                        ...
                        <div class="row row-cols-1 g-0">
                          ...
                          <div class="col mt-4 mt-md-5 mt-lg-4">
                            <div class="row text-center">
                              <div class="col-6 border-sm-end border-300"><img class="mb-2" src="./resources/Falcon/img/assets/img/icons/user-plus.svg" width="30" alt="" />
                                <h4 class="text-700" data-countup='{"endValue":79563}'>0</h4>
                                <h6 class="fw-normal mb-0">Following</h6>
                              </div>
                              <div class="col-6"><img class="mb-2" src="./resources/Falcon/img/assets/img/icons/users.svg" width="30" alt="" />
