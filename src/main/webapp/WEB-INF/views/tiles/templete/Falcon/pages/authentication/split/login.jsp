                ...
                <div class="card">
                  <div class="card-body p-4">
                    <div class="row flex-between-center">
                      ...
                      <div class="col-auto fs--1 text-600"><span><a  href="#register-custommer-modal" data-bs-toggle="modal" aria-expanded="false">계정생성</a></span></div>
                    </div>
                    <form>
                      <div class="mb-3">
                      ...
                      <div class="row flex-between-center">
                        ...
                        <div class="col-auto"><a class="fs--1" href="#fotgotpassword-modal"  data-bs-toggle="modal" aria-expanded="false">비밀번호 찾기</a></div>
                      </div>
                      <div class="mb-3">
