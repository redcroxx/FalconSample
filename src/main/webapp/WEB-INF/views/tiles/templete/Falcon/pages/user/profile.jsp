            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col ps-2 ps-lg-3"><a class="d-flex align-items-center mb-2" href="#"><span class="fas fa-user-circle fs-3 me-2 text-700" data-fa-transform="grow-2"></span>
                  ...
                  </a><a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2" src="./resources/Falcon/img/assets/img/logos/google.png" alt="Generic placeholder image" width="30" />
                    <div class="flex-1">
