                      ...
                      <table class="table table-borderless fs--1 fw-medium mb-0">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="p-1"><a class="text-600 text-decoration-none" href="mailto:goodguy@nicemail.com">goodguy@nicemail.com </a><span class="badge badge rounded-pill badge-soft-success">Verified<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
                            </td>
                          </tr>
                          <tr>
                            <td class="p-1" style="width: 35%;">Mobile No:</td>
                            <td class="p-1"><a class="text-600 text-decoration-none" href="tel:+01234567890 ">+012-345-67890 </a><span class="badge badge rounded-pill badge-soft-primary">2-step verification<span class="ms-1 fas fa-link" data-fa-transform="shrink-2"></span></span>
                            </td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            $1971.52</h4><span class="badge badge rounded-pill badge-soft-danger">5.1% last month<span class="ms-1 fas fa-caret-down" data-fa-transform="shrink-2"></span></span>
                        </div>
                  ...
                  <div class="card font-sans-serif">
                    ...
                    <div class="card-body">
                      <div class="row g-0">
                        <div class="col-6">
                          <h4 class="text-700 lh-1 mb-1">
                            121h 11m</h4><span class="badge badge rounded-pill badge-soft-success">3.6% last month<span class="ms-1 fas fa-caret-up" data-fa-transform="shrink-2"></span></span>
                        </div>
                        <div class="col-6 mt-n4 d-flex justify-content-end">
                    ...
                    <div class="col-sm-7 order-1 order-sm-0">
                      <div class="row g-sm-0 gy-4 row-cols-2 h-100 align-content-between">
                        <div class="col">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge badge rounded-pill badge-soft-success">2.1%<span class="ms-1 fas fa-caret-up" data-fa-transform="shrink-2"></span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge badge rounded-pill badge-soft-danger">5.1%<span class="ms-1 fas fa-caret-down" data-fa-transform="shrink-2"></span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge badge rounded-pill badge-soft-secondary">0.0%<span class="ms-1" data-fa-transform="shrink-2"></span></span>
                          </h6>
                        </div>
                        <div class="col">
                          <div class="d-flex gap-2 mb-3">
                          ...
                          <h6 class="mb-0"><span class="text-500 me-2">this week</span><span class="badge badge rounded-pill badge-soft-primary">3.5%<span class="ms-1 fas fa-plus" data-fa-transform="shrink-2"></span></span>
                          </h6>
                        </div>
                      </div>
                    </div>
                    ...
                    <table class="table fs--1 mb-0">
                      ...
                      <tbody class="list">
                        <tr class="fw-semi-bold">
                          ...
                          <td class="align-middle pe-card text-end native-support"><span class="badge badge rounded-pill badge-soft-undefined"><span class="ms-1" data-fa-transform="shrink-2"></span></span>
                          </td>
                        </tr>
                        <tr class="fw-semi-bold">
                          <td class="align-middle py-3"><a href="#!">
                ...
                <div class="card-body">
                  <div class="row g-3 h-100">
                    ...
                    <div class="col-sm-6 col-lg-12">
                      ...
                      </table><span class="badge badge rounded-pill badge-soft-success">Verified<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span><span class="badge badge rounded-pill badge-soft-warning">Non Billable<span class="ms-1 fas fa-exclamation-triangle" data-fa-transform="shrink-2"></span></span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row justify-content-center">
                    <div class="col-11 col-sm-10">
                      ...
                      <div class="row gx-2 my-4">
                        <div class="col-12">
                          <button class="btn btn-falcon-default d-block w-100 mb-2"><img src="./resources/Falcon/img/assets/img/logos/gmail.png" width="20" alt="" /><span class="fw-medium ms-2">Invite from Gmail</span></button>
                        </div>
                        <div class="col-12">
                ...
                <div class="col-lg-12">
                  <div class="card h-100">
                    ...
                    <div class="card-body bg-light pb-0">
                      <form>
                        <div class="mb-3">
                          <div class="row" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"avatar.png","size":"54kb","url":"team"}]}'>
                            <div class="fallback">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body bg-light">
              <form class="dropzone dropzone-multiple p-0" id="dropzoneMultipleFileUpload" data-dropzone="data-dropzone" action="#!">
                ...
                <div class="dz-message" data-dz-message="data-dz-message"> <img class="me-2" src="./resources/Falcon/img/assets/img/icons/cloud-upload.svg" width="25" alt="" />Drop your files here</div>
                <div class="dz-preview dz-preview-multiple m-0 d-flex flex-column">
                  <div class="d-flex media align-items-center mb-3 pb-3 border-bottom btn-reveal-trigger"><img class="dz-image" src="./resources/Falcon/img/assets/img/icons/cloud-upload.svg" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
                    <div class="flex-1 d-flex flex-between-center">
                      <div>
                        <h6 data-dz-name="data-dz-name"></h6>
                        <div class="d-flex align-items-center">
            ...
            <div class="col-xl-5 col-xxl-4">
              <div class="row g-3">
                ...
                <div class="col-lg-3 col-xl-12">
                  <div class="card h-100">
                    <div class="bg-holder d-none d-xl-block bg-card" style="background-image:url(./resources/Falcon/img/assets/img/icons/spot-illustrations/corner-4.png);opacity: 0.7;">
                    </div>
                    <!--/.bg-holder-->
              ...
              <div class="card">
                <div class="card-body p-4 p-sm-5">
                  <div class="text-center"><img class="d-block mx-auto mb-4" src="./resources/Falcon/img/assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                    ...
                    </p><a class="btn btn-primary btn-sm mt-3" href="pages/authentication/simple/login.html"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
                  </div>
                </div>
              </div>
            </div>
