          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
              ...
              <li class="nav-item d-none d-sm-block">
                <a class="nav-link px-0 notification-indicator notification-indicator-warning notification-indicator-fill fa-icon-wait" href="/shopping-cart.do"><span class="fas fa-shopping-cart" data-fa-transform="shrink-7" style="font-size: 33px;"></span><span class="notification-indicator-number">1</span></a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end dropdown-menu-card dropdown-menu-notification dropdown-caret-bg" aria-labelledby="navbarDropdownNotification">
                  <div class="card card-notification shadow-none">
                        ...
                        <div class="list-group-item">
                          <a class="notification notification-flush notification-unread" href="#!">
                            ...
                            <div class="notification-body">
                              <p class="mb-1"><strong>Emma Watson</strong> replied to your comment : "Hello world ?삆"</p>
                              <span class="notification-time"><span class="me-2" role="img" aria-label="Emoji">?뮠</span>Just now</span>
                        ...
                        <div class="list-group-item">
                          <a class="notification notification-flush" href="#!">
                            ...
                            <div class="notification-body">
                              ...
                              <span class="notification-time"><span class="me-2" role="img" aria-label="Emoji">?뙟截?/span>1d</span>
                        ...
                        <div class="list-group-item">
                          <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                            ...
                            <div class="notification-body">
                              ...
                              <span class="notification-time"><span class="me-2" role="img" aria-label="Emoji">?뚳툘</span>1w</span>
                        ...
                        <div class="list-group-item">
                          <a class="border-bottom-0 notification notification-flush" href="#!">
                            ...
                            <div class="notification-body">
                              ...
                              <span class="notification-time"><span class="me-2" role="img" aria-label="Emoji">?솇??/span>2d</span>
                    ...
                    <div class="card-footer text-center border-top"><a class="card-link d-block" href="/notifications.do">View all</a></div>
                  </div>
                </div>
